    ...
    <div className='bg-white rounded-md shadow-md text-gray-500 p-2'>
       ...
       <Image
        ...
        <form className='flex flex-1'>
              <input type='text' placeholder={`What's on your mind, ${session.user.name}`} className="rounded-full h-12 flex-grow focus:outline-none font-medium bg-gray-100 px-4"/>
